      ...
      <div className='max-w-6xl mx-auto px-6 py-12'>
        ...
        <section className='mb-12'>
          ...
          <p className='text-gray-700 mb-6'>
            We offer a robust TURN server platform as a service (SaaS/PaaS),
            allowing businesses to:
          </p>
          <ul className='list-disc list-inside text-gray-700 space-y-2'>
            <li>Overcome NAT traversal challenges with ease.</li>
            <li>
              Build resilient applications for video, voice, and data exchange.
            </li>
            <li>
              Scale their infrastructure effortlessly while maintaining high
              performance.
            </li>
          </ul>
          <p className='text-gray-700 mt-4'>
            Our APIs are designed with simplicity and flexibility in mind,
            enabling developers to integrate TURN server capabilities into their
          ...
          <div class='mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3'>
            <div class='relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-teal-200 p-2'>
              <div class='flex h-[180px] flex-col justify-between rounded-md p-6'>
                ...
                <div class='space-y-2'>
                  <h3 class='font-bold'>Innovation-Driven</h3>
            ...
            <div class='relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-teal-200 p-2'>
              <div class='flex h-[180px] flex-col justify-between rounded-md p-6'>
                ...
                <div class='space-y-2'>
                  <h3 class='font-bold'>Customer-Centric</h3>
                  <p class='text-sm'>
            ...
            <div class='relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-teal-200 p-2'>
              <div class='flex h-[180px] flex-col justify-between rounded-md p-6'>
                ...
                <div class='space-y-2'>
                  <h3 class='font-bold'>Scalability & Reliability</h3>
                  <p class='text-sm text-muted-foreground'>
